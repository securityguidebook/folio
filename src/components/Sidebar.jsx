...
export function Sidebar({ view, activeProjectId, projects, onNav, onSettings, onNewProject, settings, onSignOut }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '14px 14px 12px', borderBottom: '0.5px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <span style={{ fontSize: 13, fontWeight: 500, color: 'var(--text-2)', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Folio</span>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '8px 0' }}>
        ...
        {projects.length === 0 && (
          <div style={{ padding: '8px 14px', fontSize: 12, color: 'var(--text-3)', fontStyle: 'italic' }}>No projects yet</div>
        )}
      ...
      <div style={{ padding: '12px 14px', borderTop: '0.5px solid var(--border)', display: 'flex', flexDirection: 'column', gap: 8 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <div style={{ width: 24, height: 24, borderRadius: '50%', background: 'var(--acc-l)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 9, fontWeight: 500, color: 'var(--acc-m)' }}>
            {initials}
          </div>
        ...
        <button
          ...
          style={{ width: '100%', padding: '7px', fontSize: 12, color: 'var(--text-2)', border: '0.5px dashed var(--border-2)', borderRadius: 'var(--radius-md)', cursor: 'pointer', background: 'transparent', textAlign: 'center', transition: 'all 0.12s' }}
        ...
        <button
          onClick={onSignOut}
          style={{ width: '100%', padding: '7px', fontSize: 12, color: '#A32D2D', border: '0.5px solid #F09595', borderRadius: 'var(--radius-md)', cursor: 'pointer', background: 'transparent', textAlign: 'center', transition: 'all 0.12s' }}
